...
describe('Smithers', () => {
    ...
    describe('stopBuild', () => {
        ...
        it('should throw an error if the buildNumber parameter is not provided', () => expect(smithers.stopBuild.bind(smithers, 'jobName')).to.throw('Missing parameter: buildNumber'));
    });
    ...
    describe('getLastSuccessfulBuild', () => {
        ...
        it('should throw an error if the name parameter is not provided', () => expect(smithers.getLastSuccessfulBuild.bind(smithers)).to.throw('Missing parameter: name'));
    });
    ...
    describe('getLastUnsuccessfulBuild', () => {
        ...
        it('should throw an error if the name parameter is not provided', () => expect(smithers.getLastUnsuccessfulBuild.bind(smithers)).to.throw('Missing parameter: name'));
    });
    ...
    describe('getSpecificBuild', () => {
        ...
        it('should throw an error if the buildNumber parameter is not provided', () => expect(smithers.getSpecificBuild.bind(smithers, 'jobName')).to.throw('Missing parameter: buildNumber'));
    });
    ...
    describe('getView', () => {
        ...
        it('should call Caller.get with the default view name if none provided', async () => {
            ...
            expect(callerGetStub).to.be.calledWithExactly('/view/All/api/json', {});
        });
    });
